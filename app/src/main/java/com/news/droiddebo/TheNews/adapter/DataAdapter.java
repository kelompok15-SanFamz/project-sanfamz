package com.news.droiddebo.TheNews.adapter;
...
import com.news.droiddebo.TheNews.view.ArticleActivity;
    ...
    **/
    ...
    public void onBindViewHolder(DataAdapter.ViewHolder holder, int position) {
        ...
        if (title.endsWith("- ENTERTAINMENT")) {
            title = title.replace("- ENTERTAINMENT", "");
    ...
    **/
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (headLine.endsWith(" - ENTERTAINMENT")) {
                headLine = headLine.replace(" - ENTERTAINMENT", "");
