package com.news.droiddebo.TheNews.view;
...
import com.news.droiddebo.TheNews.adapter.DataAdapter;
import com.news.droiddebo.TheNews.model.ArticleStructure;
import com.news.droiddebo.TheNews.model.Constants;
import com.news.droiddebo.TheNews.model.NewsResponse;
import com.news.droiddebo.TheNews.network.ApiClient;
import com.news.droiddebo.TheNews.network.ApiInterface;
import com.news.droiddebo.TheNews.network.interceptors.OfflineResponseCacheInterceptor;
import com.news.droiddebo.TheNews.network.interceptors.ResponseCacheInterceptor;
import com.news.droiddebo.mytimes.R;
import com.news.droiddebo.TheNews.util.UtilityMethods;
...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String[] SOURCE_ARRAY = {"buzzfeed", "mashable", "mtv-news", "bbc-sport", "espn-cric-info", "talksport", "medical-news-today",
    ...
    private void createDrawer(Bundle savedInstanceState, final Toolbar toolbar, Typeface montserrat_regular) {
        ...
        result = new DrawerBuilder()
                ...
                .withToolbar(toolbar)
                .withSelectedItem(1)
                .addDrawerItems(item5, item6, item7, item8, item9,
    ...
    private void loadJSON() {
        ...
        httpClient.cache(new Cache(new File(TheNews.getTheNewsInstance().getCacheDir(), "ResponsesCache"), 10 * 1024 * 1024));
    ...
    **/
    ...
    private void sendEmail() {
        ...
        emailIntent.setData(Uri.parse("mailto: Keluargaalangalang@gmail.com"));
